# The Ethics of Data Science in Psychology {#sec-ethics}
...
As technology improves, data that previously seemed innocuous can be leveraged to reveal personal information. For example, Facebook users' "likes" were once public information. @kosinski_etal_2013 then showed that likes alone could be used to predict a user's age, gender, sexual orientation, ethnicity, religion, intelligence, drug use, and more. Facebook now makes likes private by default. <!--# Is it though? Kosinski et al., used MyPersonality -- meaning they needed people to sign into their app. I think likes are still public by default (https://www.facebook.com/help/281388201973414). The story here imo is that Facebook used to let any developer get all the data from FB about their users, whereas now it is much harder.-->
